...
function MaterialForm({
  ...
  const { control, register, handleSubmit, setValue, formState } =
    useForm<Material>({ values: initialFormData });
  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-x-4 gap-y-2">
        ...
        <Controller
          ...
          render={({ field }) => (
            <Form.Item
              label="Reference"
              help="DOI, product datasheet reference, or patent number"
            >
        ...
        <Controller
          ...
          render={({ field }) => (
            <Form.Item
              label="Author"
              help="First author, or manufacturer name for commercial materials"
          ...
          render={({ field }) => (
            <Form.Item label="Formula Name">
              <Select placeholder="Select the name of the formula" {...field}>
                <Option value="cement based concrete">
                  Cement Based Concrete
                </Option>
                <Option value="geopolymer concrete">Geopolymer Concrete</Option>
                <Option value="bioengineered concrete">
                  Bioengineered concrete
                </Option>
                <Option value="other composite materials">
        ...
        <Controller
          ...
          render={({ field }) => (
            <Form.Item
              label="Title"
              help="Report title or material name for commercial purposes"
              className="col-span-2"
            >
      ...
      <h3 className="my-4 text-lg font-normal">
        Ingredients and Related Fields
      </h3>
