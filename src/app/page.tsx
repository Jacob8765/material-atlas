...
export default function HomePage() {
  ...
  // const { data: mix } = useEntityDetails(4, ENTITY_TYPES.Mix);
  ...
  //   // const material = materialSchema.parse(entity);
  //   // console.log(material);

  //   console.log("MIX FROM PAGE", mix);
  //   console.log("Converting mix");
  //   const mixEntity = mixSchema.parse(mix);
  //   console.log(mixEntity);
  // }, [mix]);
